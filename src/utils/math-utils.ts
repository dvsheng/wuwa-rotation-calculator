...
export const calculateParameterizedNumberValue = <T extends string | number>(
  ...
  const total = (
    ...
    const parameterOffset = parameterConfig.offset ?? 0;
    ...
    const parameterContribution = parameterConfig.scale * statValue + parameterOffset;
